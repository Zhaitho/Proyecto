...
public class Parser {
    ...
    private double term() {
        ...
        while (currentToken.getTipoToken().equals("MULT") || currentToken.getTipoToken().equals("DIV")) {
            if (currentToken.getTipoToken().equals("MULT")) {
                ...
                result /= divisor; // División de decimales
            }
        }
    ...
    private double factor() {
        ...
        if (currentToken.getTipoToken().equals("NUMBER")) {
            result = Double.parseDouble(currentToken.getValor()); // Convertir a double
            consume("NUMBER");
            ...
            consume("RPAREN");
            result = Math.exp(argumento); // Exponencial con decimales
        } else {
